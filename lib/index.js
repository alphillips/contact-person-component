...
var ContactPerson = function (_React$Component) {
  ...
  function ContactPerson(props) {
    ...
    _this.getDetails = function () {
      var person = {};
      person.isDirty = _this.state.isDirty;
      ...
      if (_this.state.contactPersonCode === 'ME') {
        ...
        _this.state.isDirty = _this.state.contactPersonCode !== _this.state.contactPerson.contactPersonCode;
      } else {
        if (_this.state.linkContactPerson === "LINK") {
          person.otherClientDetail.clientEmail = _this.state.clientEmail;
          _this.state.isDirty = _this.state.clientEmail !== _this.state.contactPerson.otherClientDetail.clientEmail;
        } else {
          ...
          _this.state.isDirty = JSON.stringify(person.otherPersonDetails) !== JSON.stringify(_this.state.contactPerson.otherPersonDetails);
        }
      }
      return person;
    };
