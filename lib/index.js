  ...
  function ContactPerson(props) {
      ...
      if (JSON.stringify(_this.state.foundClientDetail) !== "{}") {
        ...
        _this.setState(function (prevState, props) {
          return {
            ...
            isDirty: _this.isValidEmail(_this.state.searchEmailKeyword) ? _this.state.searchEmailKeyword !== _this.state.contactPerson : _this.state.isDirty,
            foundClient: true,
            showManualClientEntry: false
          };
        });
    ...
    _this.onChange = function (field) {
      return function (value) {
        ...
        var oldValue = _this.state.contactPerson[field];
        if (oldValue !== value) {
          _this.setState(function (prevState, props) {
            return {
              isDirty: true
    ...
    _this.hasContactPersonChanged = function () {
