  ...
  function ContactPerson(props) {
    ...
    _this.handleClientContactPersonContinue = function () {
      ...
      if (_this.state.linkContactPersonCode && _this.state.linkContactPersonCode === "NOTLINK") {
        if (_this.state.contactFirstName === "" || _this.state.contactFirstName === null || _this.state.contactLastName === null || _this.state.contactLastName === "" || _this.state.contactEmail === "" || _this.state.contactEmail === null || !_this.isValidEmail(_this.state.contactEmail)) {

          _this.errObj = {};
          _this.errObj.type = "error";
          _this.errObj.msg = "Please complete Contact Person details";
