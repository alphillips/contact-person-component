          ...
          if (response.status === 200) {
            response.text().then(function (data) {
              ...
              if (parsedData.firstName !== null) {
                ...
                var contactEmail = _this.isValidEmail(_this.state.searchEmailKeyword) ? _this.state.searchEmailKeyword : null;
                var contactId = null;

                if (contactEmail === null) {
                  contactId = _this.state.searchEmailKeyword;
                }
    ...
    return _react2.default.createElement(
      ...
      (this.state.showManualClientEntry || this.state.linkContactPersonCode === "NOTLINK") && !this.state.showVerifyButton && _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.state.showHeading && _react2.default.createElement(
            "h3",
            null,
