  ...
  function ContactPerson(props) {
    ...
    _this.componentWillMount = function () {
      if (_this.state.contactPerson) {
        _this.setState(function (prevState, props) {
          return {
            contactPersonCode: !_this.state.contactIsMe ? "OTHERCLIENT" : "ME"
          };
        });
    ...
    _this.triggerFindClientContactPerson = function () {
      ...
      if (_this.state.searchEmailKeyword !== "") {
        ...
        fetch(URL_BASE + 'v1/contactperson/type/' + type + "/id/" + id, { credentials: 'same-origin' }).then(function (response) {
    ...
    _this.getDetails = function () {
      ...
      if (_this.state.contactPersonCode === 'ME') {
        ...
        if (_this.state.linkContactPersonCode === "LINK") {
          ...
          person.otherClientDetails.clientEmail = _this.state.clientEmail;
        } else {
    ...
    _this.contactPersonHasChanged = function () {
      ...
      if (_this.state.contactIsMe) {
        ...
        if (_this.state.linkContactPersonCode === "LINK") {
          hasChanged = _this.state.clientEmail !== _this.state.contactPerson.otherClientDetails.clientEmail;
        } else {
          hasChanged = _this.state.contactFirstName !== _this.state.contactPerson.otherPersonDetails.firstName || _this.state.contactLastName !== _this.state.contactPerson.otherPersonDetails.lastName || _this.state.contactEmail !== _this.state.contactPerson.otherPersonDetails.email || _this.state.contactPhone !== _this.state.contactPerson.otherPersonDetails.phone || _this.state.contactPersonAddress !== _this.state.contactPerson.otherPersonDetails.postalAddress;
        }
      }
